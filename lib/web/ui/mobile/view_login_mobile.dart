                        ...
                        children: [
                          ...
                          Form(
                            ...
                            child: formatTextField(
                              ...
                              globalKey: ControllerLogin.formKeyLoginPassword,
                              filteringTextInputFormatter: null,
                              iconData: Icons.lock,
                              obscureText: true,
                              function: (String text) {
                              ...
                              textEditingController:
                                  ControllerLogin.loginTextFormFieldPassword,
                            ),
                          ),
                          Form(
                            ...
                            child: formatTextField(
                              ...
                              textEditingController:
                                  ControllerLogin.loginTextFormFieldMatricula,
                            ),
                          ),
                          Padding(
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    child: Center(
                                      child: Text(_viewLogin.textButtonLogin),
                                    ),
                                  ),
                                ),
                              ),
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    inkwellText(
                                        textName:
                                            _viewLogin.textEsqueciSenhaLink,
                                        function: () {
                                          ControllerAllMethods()
                                              .transitionScreen(

  ...
  Widget build(BuildContext context) {
    final List<Widget> fancyCards = [
      ViewQuizMobile(
        ...
        function: (){ControllerAllMethods().pageTransition(nameRoute: Routes.QUIZ_ADS, context: context);},
      ),
      ViewQuizMobile(
        title: "Resultados",
        image: Image.asset("assets/images/resultado.png"),
        titleButton: "Mostrar resultados",
        function: (){ControllerAllMethods().pageTransition(nameRoute: Routes.RESULTS, context: context);},
      ),
      ViewQuizMobile(
        title: "Quiz - REDES",
        image: Image.asset("assets/images/redes.png"),
        titleButton: "Iniciar Quiz",
        function: (){ControllerAllMethods().pageTransition(nameRoute: Routes.QUIZ_NETWORK, context: context);},
      ),
    ];

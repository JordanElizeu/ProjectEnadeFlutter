...
import 'package:project_enade/web/controller/register_controller/controller_register.dart';
import 'package:project_enade/web/router/app_routes.dart';

class ViewRegisterTablet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      ControllerAllMethods()
          .pageTransition(nameRoute: Routes.LOGIN, context: context) ??
          false,
      child: Center(
        child: Material(
